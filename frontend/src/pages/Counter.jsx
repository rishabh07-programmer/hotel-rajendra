...
function Counter() {
  ...
  const fetchWaiters = async () => {
    try {
      const res = await axios.get('http://localhost:8080/api/auth/waiters', {
        headers: { authorization: token }
      })
      setWaiters(res.data)
    } catch (err) {
  ...
  const fetchTodaySales = async () => {
    try {
      const res = await axios.get('http://localhost:8080/api/analytics/today', {
        headers: { authorization: token }
      })
  ...
  const fetchMonthlySales = async (month, year) => {
    try {
      const res = await axios.get(`http://localhost:8080/api/analytics/monthly/${year}/${month}`, {
        headers: { authorization: token }
      })
  ...
  const fetchYearlySales = async (year) => {
    try {
      const res = await axios.get(`http://localhost:8080/api/analytics/yearly/${year}`, {
        headers: { authorization: token }
      })
  ...
  const fetchTopItems = async () => {
    try {
      const res = await axios.get('http://localhost:8080/api/analytics/top-items', {
        headers: { authorization: token }
      })
  ...
  const fetchMonthlyTopItems = async (month, year) => {
    try {
      const res = await axios.get(`http://localhost:8080/api/analytics/top-items?month=${month}&year=${year}`, {
        headers: { authorization: token }
      })
      setTopItems(res.data)
    } catch (err) {
  ...
  const fetchYearlyTopItems = async (year) => {
    try {
      const res = await axios.get(`http://localhost:8080/api/analytics/top-items?year=${year}`, {
        headers: { authorization: token }
      })
      setTopItems(res.data)
    } catch (err) {
  ...
  const sendToKitchen = async () => {
    try {
      if (selectedOrder._id) {
        await axios.post(`http://localhost:8080/api/orders/addItems/${selectedOrder._id}`,
          { items: selectedOrder.items },
          { headers: { authorization: token } }
        )
        const res = await axios.get('http://localhost:8080/api/orders/active', { headers: { authorization: token } })
        const refreshed = res.data.find(o => o._id === selectedOrder._id)
        if (refreshed) setSelectedOrder(refreshed)
      } else {
        const res = await axios.post('http://localhost:8080/api/orders/new',
  ...
  const saveAndBill = async () => {
    try {
      if (selectedOrder._id) {
        ...
        await axios.post(`http://localhost:8080/api/orders/bill/${selectedOrder._id}`, {}, { headers: { authorization: token } })
      } else {
        const res = await axios.post('http://localhost:8080/api/orders/new',
          { tableNumber: selectedOrder.tableNumber, items: selectedOrder.items },
          { headers: { authorization: token } }
        )
        await axios.post(`http://localhost:8080/api/orders/bill/${res.data.order._id}`, {}, { headers: { authorization: token } })
      }
      printBill()
  ...
  const cancelOrder = async () => {
    ...
    try {
      await axios.post(`http://localhost:8080/api/orders/cancel/${selectedOrder._id}`, {}, { headers: { authorization: token } })
      setSelectedOrder(null)
      setDiscount(0)
      fetchActiveOrders()
    } catch (err) { console.log(err) }
  ...
  const saveItemPrice = async (item) => {
    try {
      await axios.post(`http://localhost:8080/api/menu/update/${item._id}`,
  ...
  const deleteItem = async (item) => {
    ...
    try {
      await axios.post(`http://localhost:8080/api/menu/delete/${item._id}`, {}, { headers: { authorization: token } })
      fetchMenu()
  ...
  const addWaiter = async () => {
    ...
    try {
      await axios.post('http://localhost:8080/api/auth/waiter/create',
  ...
  const deleteWaiter = async (id) => {
    ...
    try {
      await axios.post(`http://localhost:8080/api/auth/waiter/delete/${id}`, {}, { headers: { authorization: token } })
      fetchWaiters()
